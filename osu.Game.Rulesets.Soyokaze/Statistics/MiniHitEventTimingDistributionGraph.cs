...
{
    /// <summary>
    /// THIS CODE IS COPIED FROM <see cref="HitTimingDistributionGraph"/>.
    /// THE ONLY DIFFERENCE IS THE NUMBER OF BINS.
    /// TODO: PR a non-const timing_distribution_bins lmfao but shit man i am lazy
    /// </summary>
    public partial class MiniHitEventTimingDistributionGraph : CompositeDrawable
    {
        /// <summary>
        /// The number of bins on each side of the timing distribution.
        /// </summary>
        private const int timing_distribution_bins = 18;
